...
locals {
  ...
  # Public subnets exist only in auto-create mode (they host the NAT Gateway).
  # When reusing an existing VPC nothing in this stack needs public subnets:
  # the ALB is internal and Fargate tasks run in private subnets.
